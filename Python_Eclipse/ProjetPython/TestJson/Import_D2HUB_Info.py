...
def Extract_infos_from_D2hHub():
    ...
    Import_from_ImportD2HUB()       #lecture des donn�es de "genericInfo.txt"
    Import_from_ExportD2HUBcsv()    #lecture des donn�es de "export.csv"
    Dict_from_D2Hub_exports()       #assemblage des donn�es des 2 sources dans un dictionnaire
    ...
    #Effacement des 2 premi�res listes pour gagner en m�moire vive. 
    item_list_1.clear()
    item_list_2.clear()
